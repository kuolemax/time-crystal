...
public class Config {
    ...
    public static void synchronizeConfiguration() {
        ...
        overPoweredRecipe = configuration.getBoolean("OverPoweredRecipe", Configuration.CATEGORY_GENERAL, overPoweredRecipe, "Is the recipe for Torcherino extremely OP?", "config.property.OverPoweredRecipe");
